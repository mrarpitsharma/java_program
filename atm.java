         ...
         if(slot==1)
          {
           ...
           // System.out.println("1:BALANCE INQUIRY.  2:MINI STATEMENT.  3:SERVICES.  4:BILL PAYMENTS");
           // System.out.println("5:FAST CASH.  6:CASH WITHDRAWAL.   7:PIN CHANGE.   8:FUNDS TRANSFER");
            int ch=sc.nextInt();
            switch(ch)
             {
                case 1:
                ...
                case 6:
                 {
                    ...
                    //  {
                    //     System.out.println("DO YOU WANT (1.)'100' RUPESS NOTE OR (2.)'500' RUPESS NOTE");
                    //     int note=sc.nextInt();
                    //     if(note==1)
                    //      {
                    //         for(int i=1;i<=amt;i++)
